...
/// <summary>
/// Database view: current season stats as cumulative minus the previous <c>time_season</c> snapshot row for the player, or all zeros if that snapshot row is missing.
/// </summary>
public class ExperimentalSpecsWlCurrentSeason
{
