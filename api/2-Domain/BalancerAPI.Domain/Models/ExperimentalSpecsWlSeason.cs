...
/// <summary>
/// Result shape for <c>experimental_specs_wl_season</c> view: per-spec W/L/K/D for a completed season
/// (snapshot at season_start_date S+1 minus snapshot at S from <see cref="ExperimentalSpecsWlSeasonal"/>).
/// </summary>
public class ExperimentalSpecsWlSeason
{
